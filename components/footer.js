        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Sydney's premier eco-friendly cleaning service. Professional,
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/Sustainableshinecs"
                className="bg-gray-800 hover:bg-emerald-500 p-3 rounded-lg transition-colors duration-300"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
